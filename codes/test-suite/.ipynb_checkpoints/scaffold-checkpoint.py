...
def benchmark(
    ...
    if op.__name__ in Padding: # TODO: check
        ...
        results_df = pd.DataFrame(columns=['batch_size', 'dim' 'dtype', 'padding',  'average_relative_error', 'average_runtime'])
        for dtype in dimensions["dtype"]:
    ...
    if op.__name__ == "MaxUnpool1d" or op.__name__ == "MaxUnpool2d" or op.__name__ == "MaxUnpool3d":
        results_df = pd.DataFrame(columns=['batch_size', 'dim', 'dtype', 'stride', 'padding', 'kernel_size', 'average_relative_error', 'average_runtime'])
    ...
    if op.__name__ == "FractionalMaxPool2d" or op.__name__ == "FractionalMaxPool3d": # TODO: check
        ...
        results_df = pd.DataFrame(columns=['batch_size', 'dim', 'dtype', 'reduction_ratio', 'kernel_size', 'average_relative_error', 'average_runtime'])
    ...
    if op.__name__ in Conv: # TODO: check
        ...
        results_df = pd.DataFrame(columns=['batch_size', 'dim', 'dtype', 'kernel_size', 'stride', 'padding', 'dilation', 'group', 'average_relative_error', 'average_runtime'])
    ...
    if op.__name__ in ConvTranspose: # TODO: check
        ...
        results_df = pd.DataFrame(columns=['batch_size', 'dim', 'dtype', 'kernel_size', 'stride', 'padding', 'dilation', 'group', 'reduction_ratio', 'average_relative_error', 'average_runtime'])
    ...
    if op.__name__ == "scatter_reduce":
        ...
        results_df = pd.DataFrame(columns=['input_dimensions', 'reduction_ratio', 'dtype', 'dim', 'reduce', 'include_self'])
        for input_dimension in dimensions["input_dimensions"]:
            for dtype in dimensions["dtype"]:
                for reduction_ratio in dimensions["reduction_ratio"]:
    ...
    if op.__name__ == "scatter":
        ...
        results_df = pd.DataFrame(columns=['input_dimensions', 'reduction_ratio', 'dtype', 'dim', 'reduce'])
        for input_dimension in dimensions["input_dimensions"]:
            for dtype in dimensions["dtype"]:
                for reduction_ratio in dimensions["reduction_ratio"]:
                    src = data_dist(torch.zeros(input_dimension)).to(dtype).to(device)
    ...
    if op.__name__ == "index_select":
        ...
        results_df = pd.DataFrame(columns=['input_dimensions', 'reduction_ratio', 'dtype', 'dim'])
        for input_dimension in dimensions["input_dimensions"]:
            for dtype in dimensions["dtype"]:
                for reduction_ratio in dimensions["reduction_ratio"]:
                    input = data_dist(torch.zeros(input_dimension)).to(dtype).to(device)
    ...
    if op.__name__ == "bmm":
        ...
        results_df = pd.DataFrame(columns=['batch', 'n', 'm', 'p'])
        for dtype in dimensions["dtype"]:
    ...
    if op.__name__ == "index_put":
        ...
        results_df = pd.DataFrame(columns=['input_dimensions', 'reduction_ratio', 'dtype', 'accumulate'])
        for input_dimension in dimensions["input_dimensions"]:
            for dtype in dimensions["dtype"]:
                for reduction_ratio in dimensions["reduction_ratio"]:
                    input = data_dist(torch.zeros(input_dimension)).to(dtype).to(device) 
    ...
    if op.__name__ == "histc":
        ...
        results_df = pd.DataFrame(columns=['input_dimensions', 'reduction_ratio', 'dtype', 'min', 'max'])
        for input_dimension in dimensions["input_dimensions"]:
            for dtype in dimensions["dtype"]:
                for reduction_ratio in dimensions["reduction_ratio"]:
    ...
    if op.__name__ == "bincount":
        ...
        results_df = pd.DataFrame(columns=['input_dimensions', 'reduction_ratio', 'dtype', 'minlength'])
    ...
    if op.__name__ == "kthvalue":
        ...
        results_df = pd.DataFrame(columns=['input_dimensions', 'dim', 'dtype', 'k'])
    ...
    if op.__name__ == "median":
        ...
        results_df = pd.DataFrame(columns=['input_dimensions', 'dim', 'dtype', 'keepdim'])
        for input_dimension in dimensions["input_dimensions"]:
            for dtype in dimensions["dtype"]:
                input = data_dist(torch.zeros(input_dimension)).to(dtype).to(device)
                for dim in dimensions["dim"]:
    ...
    if op.__name__ == "AvgPool3d": # TODO: check
        ...
        results_df = pd.DataFrame(columns=['batch_size', 'dim', 'dtype', 'kernel_size', 'stride', 'padding', 'ceil_mode', 'count_include_pad', 'average_relative_error', 'average_runtime'])
    ...
    if op.__name__ == "AdaptiveAvgPool2d" or op.__name__ == "AdaptiveMaxPool2d" or op.__name__ == "AdaptiveAvgPool3d": # TODO: check
        ...
        results_df = pd.DataFrame(columns=['batch_size', 'dim', 'dtype', 'reduction_ratio', 'output_size'])
    ...
    if op.__name__ == "MaxPool3d": # TODO: check
        ...
        results_df = pd.DataFrame(columns=['batch_size', 'dim', 'dtype', 'kernel_size', 'stride', 'padding', 'dilation', 'ceil_mode', 'average_relative_error', 'average_runtime'])
