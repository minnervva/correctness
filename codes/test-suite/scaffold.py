...
def benchmark(
    ...
    if op.__name__ in ConvTranspose: # TODO: check
        ...
        results_df = pd.DataFrame(columns=['batch_size', 'dim', 'dtype', 'kernel_size', 'stride', 'padding', 'dilation', 'group', 'reduction_ratio', 'average_relative_error', 'average_runtime', 'unique_outputs', 'unique_outputs_per_iteration'])
    ...
    if op.__name__ == "scatter_reduce":
        ...
        results_df = pd.DataFrame(columns=['input_dimensions', 'reduction_ratio', 'dtype', 'dim', 'reduce', 'include_self', "unique_outputs", 'unique_outputs_per_iteration'])
        for input_dimension in dimensions["input_dimensions"]:
            for dtype in dimensions["dtype"]:
                for reduction_ratio in dimensions["reduction_ratio"]:
